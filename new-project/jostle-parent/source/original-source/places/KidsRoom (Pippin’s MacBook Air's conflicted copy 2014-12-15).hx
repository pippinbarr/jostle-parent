...
class KidsRoom extends Place
{
			...
			DoorMovables:FlxGroup, Child1:Child, Child2:Child, Child3:Child):Void
	{
		...
		else
		{
			...
			chair3 = new PhysicsSprite(OFFSET_X + 6 * 8, OFFSET_Y + 28 * 8, AssetPaths.kids_bedroom_chair__png, 1, 0.25, 15, true, false);
		...
		chair1 = new PhysicsSprite(chair1_x, chair1_y, AssetPaths.kids_bedroom_chair__png, 1, 0.25, 15, true, false, false, 1, 1, true, 4, 7);
		...
		chair2 = new PhysicsSprite(chair2_x, chair2_y, AssetPaths.kids_bedroom_chair__png, 1, 0.25, 15, true, false, false, 1, 1, true, 4, 7);
		...
		chair3 = new PhysicsSprite(chair3_x, chair3_y, AssetPaths.kids_bedroom_chair__png, 1, 0.25, 15, true, false, false, 1, 1, true, 4, 7);
		...
		single_bed = new PhysicsSprite(single_bed_x, single_bed_y, AssetPaths.kids_bedroom_single_bed__png, 1, 0.25, 10, true, false, false, 1, 1, true, 13,
			11);
	...
	override public function update():Void
	{
		...
		if (PlayState.child1.location == this.location)
			checkTV(PlayState.child1);
		if (PlayState.child2.location == this.location)
			checkTV(PlayState.child2);
		if (PlayState.child3.location == this.location)
