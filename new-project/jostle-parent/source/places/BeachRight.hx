...
class BeachRight extends Place
{
	...
	public function new(bg:FlxGroup, display:FlxTypedGroup<Sortable>, fg:FlxGroup, Doors:FlxGroup, DoorMovables:FlxGroup):Void
	{
		...
		var cliff:PhysicsSprite = new PhysicsSprite(OFFSET_X + WIDTH - 5 * 8, OFFSET_Y + 12 * 8, AssetPaths.beach_right_cliff__png, 1, 1, 1, false);
