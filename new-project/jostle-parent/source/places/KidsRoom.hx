...
class KidsRoom extends Place
{
	...
	private var chair1:BedChair;
	private var desk2:PhysicsSprite;
	private var chair2:BedChair;
	private var desk3:PhysicsSprite;
	private var chair3:BedChair;
	...
	private var single_bed:BedChair;
	...
	public function new(bg:FlxGroup, display:FlxTypedGroup<Sortable>, Child1InBed:Bool, Child2InBed:Bool, Child3InBed:Bool, Doors:FlxGroup,
			DoorMovables:FlxGroup, Child1:Child, Child2:Child, Child3:Child):Void
	{
		...
		toHallway = new Door(bottomLeftWall.x + bottomLeftWall.width, bottomLeftWall.y + 2 * 8, this, new FlxPoint(-1, bottomLeftWall.y - 2 * 8),
			"KidsRoom.toHallway", DOWN);
		...
		if (FlxG.save.data.kids_room_bunk_bed != null)
		{
			...
			table = new PhysicsSprite(FlxG.save.data.kids_room_table.x, FlxG.save.data.kids_room_table.y, AssetPaths.kids_bedroom_table__png, 1, 0.2, 10,
				true, false);

			dresser1 = new PhysicsSprite(FlxG.save.data.kids_room_dresser1.x, FlxG.save.data.kids_room_dresser1.y, AssetPaths.kids_bedroom_dresser__png, 1,
				0.25, 40, true, false);

			dresser2 = new PhysicsSprite(FlxG.save.data.kids_room_dresser2.x, FlxG.save.data.kids_room_dresser2.y, AssetPaths.kids_bedroom_dresser__png, 1,
				0.25, 40, true, false);

			desk1 = new PhysicsSprite(FlxG.save.data.kids_room_desk1.x, FlxG.save.data.kids_room_desk1.y, AssetPaths.kids_bedroom_desk__png, 1, 0.25, 15,
				true, false);

			chair1_x = FlxG.save.data.kids_room_chair1.x;
			chair1_y = FlxG.save.data.kids_room_chair1.y;

			desk2 = new PhysicsSprite(FlxG.save.data.kids_room_desk2.x, FlxG.save.data.kids_room_desk2.y, AssetPaths.kids_bedroom_desk__png, 1, 0.25, 15,
				true, false);

			chair2_x = FlxG.save.data.kids_room_chair2.x;
			chair2_y = FlxG.save.data.kids_room_chair2.y;

			desk3 = new PhysicsSprite(FlxG.save.data.kids_room_desk3.x, FlxG.save.data.kids_room_desk3.y, AssetPaths.kids_bedroom_desk__png, 1, 0.25, 15,
				true, false);

			chair3_x = FlxG.save.data.kids_room_chair3.x;
			chair3_y = FlxG.save.data.kids_room_chair3.y;

			tv = new PhysicsSprite(FlxG.save.data.kids_room_tv.x, FlxG.save.data.kids_room_tv.y, AssetPaths.kids_bedroom_tv__png, 1, 0.25, 40, true, false,
				false, 1, 1, true, 10, 10);
			...
			tv_box = new PhysicsSprite(FlxG.save.data.kids_room_tv_box.x, FlxG.save.data.kids_room_tv_box.y, AssetPaths.kids_bedroom_tv_box__png, 1, 0.25, 20,
				true, false);
		}
		else
		{
			table = new PhysicsSprite(OFFSET_X + WIDTH - 13 * 8, OFFSET_Y + 18 * 8, AssetPaths.kids_bedroom_table__png, 1, 0.2, 10, true, false);

			dresser1 = new PhysicsSprite(OFFSET_X + 2 * 8, OFFSET_Y + 4 * 8, AssetPaths.kids_bedroom_dresser__png, 1, 0.25, 40, true, false);

			dresser2 = new PhysicsSprite(OFFSET_X + 9 * 8, OFFSET_Y + 4 * 8, AssetPaths.kids_bedroom_dresser__png, 1, 0.25, 40, true, false);

			desk1 = new PhysicsSprite(OFFSET_X + 2 * 8, OFFSET_Y + 16 * 8, AssetPaths.kids_bedroom_desk__png, 1, 0.25, 15, true, false);

			desk2 = new PhysicsSprite(OFFSET_X + 2 * 8, OFFSET_Y + 22 * 8, AssetPaths.kids_bedroom_desk__png, 1, 0.25, 15, true, false);

			desk3 = new PhysicsSprite(OFFSET_X + 2 * 8, OFFSET_Y + 28 * 8, AssetPaths.kids_bedroom_desk__png, 1, 0.25, 15, true, false);

			tv = new PhysicsSprite(OFFSET_X + 16 * 8, OFFSET_Y + 2 * 8, AssetPaths.kids_bedroom_tv__png, 1, 0.25, 40, true, false, false, 1, 1, true, 10, 10);

			tv.animation.add("off", [0, 0], 1, false);
			tv.animation.add("on", [1, 2, 3, 4], 10, true);
			tv.dispatcher.addEventListener("MEDIUM", handleTVJostle);

			tv_box = new PhysicsSprite(OFFSET_X + 27 * 8, OFFSET_Y + 7 * 8, AssetPaths.kids_bedroom_tv_box__png, 1, 0.25, 20, true, false);
		}
		...
		chair1 = new BedChair(chair1_x, chair1_y, AssetPaths.kids_bedroom_chair__png, 1, 0.25, 15, true, false, false, 1, 1, true, 4, 7, "", 8, false,
			Physics.SOLID, Physics.SOLID | Physics.PARENT, this, FURNITURE, PlayState.child1.childColor, PlayState.child1.childColor,
			PlayState.child1.childColor, PlayState.child2.childColor, PlayState.child3.childColor);
		chair1.setupAnimation([0, 0], [0, 0], [1, 1], [2, 2], [3, 3], PlayState.child1.childColor, PlayState.child1.childColor, PlayState.child2.childColor,
			PlayState.child3.childColor);
		chair1.replaceColor(0xFFFF0000, PlayState.child1.childColor);
		chair1.replaceColor(0xFF00FFFF, PlayState.child2.childColor);
		chair1.replaceColor(0xFF0000FF, PlayState.child3.childColor);

		chair1.animation.play("empty");
		var chair1Trigger:FlxSprite = new FlxSprite();
		chair1Trigger.makeGraphic(1, Std.int(chair1.hit.height * 3), 0xFFFF0000);
		chair1Trigger.visible = false;
		chair1.addTrigger(chair1Trigger);

		chair2 = new BedChair(chair2_x, chair2_y, AssetPaths.kids_bedroom_chair__png, 1, 0.25, 15, true, false, false, 1, 1, true, 4, 7, "", 8, false,
			Physics.SOLID, Physics.SOLID | Physics.PARENT, this, FURNITURE, PlayState.child1.childColor, PlayState.child1.childColor,
			PlayState.child1.childColor, PlayState.child2.childColor, PlayState.child3.childColor);
		chair2.setupAnimation([0, 0], [0, 0], [1, 1], [2, 2], [3, 3], PlayState.child1.childColor, PlayState.child1.childColor, PlayState.child2.childColor,
			PlayState.child3.childColor);
		chair2.replaceColor(0xFFFF0000, PlayState.child1.childColor);
		chair2.replaceColor(0xFF00FFFF, PlayState.child2.childColor);
		chair2.replaceColor(0xFF0000FF, PlayState.child3.childColor);

		chair2.animation.play("empty");
		var chair2Trigger:FlxSprite = new FlxSprite();
		chair2Trigger.makeGraphic(1, Std.int(chair2.hit.height * 3), 0xFFFF0000);
		chair2Trigger.visible = false;
		chair2.addTrigger(chair2Trigger);

		chair3 = new BedChair(chair3_x, chair3_y, AssetPaths.kids_bedroom_chair__png, 1, 0.25, 15, true, false, false, 1, 1, true, 4, 7, "", 8, false,
			Physics.SOLID, Physics.SOLID | Physics.PARENT, this, FURNITURE, PlayState.child1.childColor, PlayState.child1.childColor,
			PlayState.child1.childColor, PlayState.child2.childColor, PlayState.child3.childColor);
		chair3.setupAnimation([0, 0], [0, 0], [1, 1], [2, 2], [3, 3], PlayState.child1.childColor, PlayState.child1.childColor, PlayState.child2.childColor,
			PlayState.child3.childColor);
		chair3.replaceColor(0xFFFF0000, PlayState.child1.childColor);
		chair3.replaceColor(0xFF00FFFF, PlayState.child2.childColor);
		chair3.replaceColor(0xFF0000FF, PlayState.child3.childColor);

		chair3.animation.play("empty");
		var chair3Trigger:FlxSprite = new FlxSprite();
		chair3Trigger.makeGraphic(1, Std.int(chair3.hit.height * 3), 0xFFFF0000);
		chair3Trigger.visible = false;
		chair3.addTrigger(chair3Trigger);

		// bunk_bed = new PhysicsSprite(bunk_bed_x, bunk_bed_y, AssetPaths.kids_bedroom_bunk_bed__png, 1, 0.25, 10, true, false, false, 1, 1, true, 13, 12);
		bunk_bed = new PhysicsSprite(bunk_bed_x, bunk_bed_y, AssetPaths.kids_bedroom_bunk_bed__png, 1, 0.25, 10, true, false, false, 1, 1, true, 13, 12, "",
			-1, false, -1, -1, PlayState.child2.childColor, PlayState.child3.childColor, PlayState.parent.parentColor, PlayState.parent.parentColor,
			PlayState.parent.parentColor);
		bunk_bed.replaceColor(0xFF000000, PlayState.child2.childColor);
		bunk_bed.replaceColor(0xFFFFFFFF, PlayState.child3.childColor);
		...
		single_bed = new BedChair(single_bed_x, single_bed_y, AssetPaths.kids_bedroom_single_bed__png, 1, 0.25, 10, true, false, false, 1, 1, true, 13, 11,
			"", 8, false, Physics.SOLID, Physics.SOLID | Physics.PARENT, this, BED, PlayState.child1.childColor, PlayState.child1.childColor,
			PlayState.child1.childColor, PlayState.child2.childColor, PlayState.child3.childColor);
		single_bed.setupAnimation([0, 0], [1, 1], [2, 3], [4, 5], [6, 7], Child1.childColor, Child1.childColor, Child2.childColor, Child3.childColor);
		single_bed.replaceColor(0xFF000000, PlayState.child1.childColor);
		single_bed.replaceColor(0xFFFF0000, PlayState.child1.childColor);
		single_bed.replaceColor(0xFF00FFFF, PlayState.child2.childColor);
		single_bed.replaceColor(0xFF0000FF, PlayState.child3.childColor);
		...
		single_bed.addTrigger(singleBedTrigger);
		...
		// single_bed.dispatcher.addEventListener("MEDIUM",handleSingleBedJumpJostle,false);
		// jumpTimer = new FlxTimer().start();
		// jumpTimer.start(JUMP_DELAY_MIN + Math.random() * JUMP_DELAY_RANGE);

		if (FlxG.save.data.kids_room_tv_on != null && FlxG.save.data.kids_room_tv_on == true)
		...
		// replaceColors(chair1);
		// replaceColors(chair2);
		// replaceColors(chair3);

		// single_bed.replaceColor(FlxColor.BLACK, PlayState.child1.childColor);
		// replaceColors(single_bed);

		// bunk_bed.replaceColor(FlxColor.BLACK, PlayState.child2.childColor);
		// bunk_bed.replaceColor(FlxColor.WHITE, PlayState.child3.childColor);
		...
		bg.add(toHallway);
		bg.add(chair1Trigger);
		bg.add(chair2Trigger);
		bg.add(chair3Trigger);

		for (i in 0...doors.length)
			Doors.add(doors[i]);

		for (i in 0...toys.length)
			DoorMovables.add(toys[i].hit);
		DoorMovables.add(desk1.hit);
		DoorMovables.add(chair1.hit);
		DoorMovables.add(desk2.hit);
		DoorMovables.add(chair2.hit);
		DoorMovables.add(desk3.hit);
		DoorMovables.add(chair3.hit);
		DoorMovables.add(tv.hit);
		DoorMovables.add(tv_box.hit);
	...
	override public function destroy():Void
	{
		...
		bunk_bed.destroy();
		single_bed.destroy();
		singleBedTrigger.destroy();
		bunkBedTrigger.destroy();
	...
	override public function update():Void
	{
		...
		if (PlayState.child1.place == this)
			checkTV(PlayState.child1);
		if (PlayState.child2.place == this)
			checkTV(PlayState.child2);
		if (PlayState.child3.place == this)
			checkTV(PlayState.child3);

		if (PlayState.task != PUT_KIDS_TO_BED)
		{
			single_bed.checkUser(PlayState.child1);
			single_bed.checkUser(PlayState.child2);
			single_bed.checkUser(PlayState.child3);

			chair1.checkUser(PlayState.child1);
			chair1.checkUser(PlayState.child2);
			chair1.checkUser(PlayState.child3);

			chair2.checkUser(PlayState.child1);
			chair2.checkUser(PlayState.child2);
			chair2.checkUser(PlayState.child3);

			chair3.checkUser(PlayState.child1);
			chair3.checkUser(PlayState.child2);
			chair3.checkUser(PlayState.child3);
		}

		if (PlayState.task == PUT_KIDS_TO_BED && PlayState.parent.place == this)
		{
	...
	public function setupBeds(Child1InBed:Bool, Child2InBed:Bool, Child3InBed:Bool):Void
	{
		...
		if (!Child2InBed && !Child3InBed)
			bunk_bed.animation.play("empty");
		else if (Child2InBed && Child3InBed)
			bunk_bed.animation.play("both");
		else if (Child2InBed)
			bunk_bed.animation.play("child2");
		else
			bunk_bed.animation.play("child3");
	...
	public function wakeFromBunkbed(c:Child, offset:Int):Void
	{
		...
		{
			c.moveTo(bunk_bed.hit.x + offset, bunk_bed.hit.y + bunk_bed.hit.height - c.height + c.hit.height, this);
		}
		else
		{
			c.moveTo(bunk_bed.hit.x + offset, bunk_bed.hit.y - c.height, this);
		}
	...
	public function wakeFromSingleBed(c:Child):Void
	{
		...
		{
			c.moveTo(single_bed.hit.x
				+ single_bed.hit.width / 2
				- c.hit.width / 2, single_bed.hit.y
				+ single_bed.hit.height
				- c.height
				+ c.hit.height, this);
		}
		else
		{
			c.moveTo(single_bed.hit.x + single_bed.hit.width / 2 - c.hit.width / 2, single_bed.hit.y - c.height, this);
		}
