...
class KidsRoom extends Place
{
		...
		Child1:Child,Child2:Child,Child3:Child):Void
	{
		...
		chair1 = new BedChair(
			...
			1,0.25,15,true,false,false,1,1,true,4,7,"",8,false,Physics.SOLID,Physics.SOLID|Physics.PARENT,this,FURNITURE);
		chair1.setupAnimation(
			[0,0],[0,0],[1,1],[2,2],[3,3],
		...
		single_bed = new BedChair(
			single_bed_x,
			single_bed_y,
			AssetPaths.kids_bedroom_single_bed__png,
			1,0.25,10,true,false,false,1,1,true,13,11,"",8,false,Physics.SOLID,Physics.SOLID|Physics.PARENT,this,BED);
		single_bed.setupAnimation([0,0],[1,1],[2,3],[4,5],[6,7],
			Child1.childColor,Child1.childColor,Child2.childColor,Child3.childColor);
	...
	override public function destroy():Void
	{
		...
		for (i in 0...toys.length) toys[i].destroy();
	}
	...
	override public function update():Void
	{
		...
		if (PlayState.child1.place == this) checkTV(PlayState.child1);
		if (PlayState.child2.place == this) checkTV(PlayState.child2);
		if (PlayState.child3.place == this) checkTV(PlayState.child3);
	...
	public function wakeFromSingleBed(c:Child):Void
	{
		...
		{
			c.moveTo(single_bed.hit.x + single_bed.hit.width/2 - c.hit.width/2,single_bed.hit.y + single_bed.hit.height - c.height + c.hit.height,this);
		}
		else
		{
