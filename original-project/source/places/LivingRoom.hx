...
class LivingRoom extends Place
{
	...
	public function new(bg:FlxGroup,display:FlxTypedGroup<Sortable>,Doors:FlxGroup,DoorMovables:FlxGroup,Child1:Child,Child2:Child,Child3:Child):Void
	{
		...
		var topRightWall:Wall = new Wall(Std.int(topLeftWall.x + topLeftWall.width) + DOOR_WIDTH,Std.int(topLeftWall.y),17*8,8, AssetPaths.living_room_wall_tile__png);
		...
		var middleRightWall:Wall = new Wall(Std.int(middleLeftWall.x + middleLeftWall.width + DOOR_WIDTH),Std.int(middleLeftWall.y),9*8,8,AssetPaths.living_room_wall_tile__png);
		
		var bottomLeftWall:Wall = new Wall(OFFSET_X,OFFSET_Y + HEIGHT - 8,27*8,8, AssetPaths.living_room_wall_tile__png);
		var bottomRightWall:Wall = new Wall(Std.int(bottomLeftWall.x + bottomLeftWall.width + DOOR_WIDTH),Std.int(bottomLeftWall.y),26*8,8, AssetPaths.living_room_wall_tile__png);
		
		var rightWall:Wall = new Wall(OFFSET_X + WIDTH - 8,OFFSET_Y + 8,8,HEIGHT - 2*8,AssetPaths.living_room_wall_tile__png);


		toHallway = new Door(middleLeftWall.x + middleLeftWall.width,middleLeftWall.y - 2*8,this,new FlxPoint(-1,middleLeftWall.y + 2*8),"LivingRoom.toHallway",UP);
		doors.push(toHallway);

		toGarden = new Door(topLeftWall.x + topLeftWall.width,topLeftWall.y - 2*8,this,new FlxPoint(-1,topLeftWall.y + 2*8),"LivingRoom.toGarden",UP);
		doors.push(toGarden);

		toFrontOfHouse = new Door(bottomLeftWall.x + bottomLeftWall.width,bottomLeftWall.y + 2*8,this,new FlxPoint(-1,bottomLeftWall.y - 2*8),"LivingRoom.toFrontOfHouse",DOWN);
		...
		if (FlxG.save.data.living_room_tv != null)
		{
			...
			tv = new PhysicsSprite(
				FlxG.save.data.living_room_tv.x,FlxG.save.data.living_room_tv.y,
				AssetPaths.living_room_tv__png,1,0.25,40,true,false,false,1,1,true,9,10);
			tv.animation.add("off",[1,1],1,false);
			tv.animation.add("on",[0,2,3,4],10,true);

			tv.dispatcher.addEventListener("MEDIUM",handleTVJostle);			

			coffee_table = new PhysicsSprite(FlxG.save.data.living_room_coffee_table.x,FlxG.save.data.living_room_coffee_table.y,AssetPaths.living_room_coffee_table__png,1,0.25,20,true);
			sofa = new PhysicsSprite(FlxG.save.data.living_room_sofa.x,FlxG.save.data.living_room_sofa.y,AssetPaths.living_room_sofa__png,1,0.25,30,true);
			sideboard = new PhysicsSprite(FlxG.save.data.living_room_sideboard.x,FlxG.save.data.living_room_sideboard.y,AssetPaths.dining_room_sideboard__png,1,0.25,30,true);
			dining_table = new PhysicsSprite(FlxG.save.data.living_room_dining_table.x,FlxG.save.data.living_room_dining_table.y,AssetPaths.dining_room_table__png,1,0.25,20,true);
			...
			fridge = new PhysicsSprite(FlxG.save.data.living_room_fridge.x,FlxG.save.data.living_room_fridge.y,AssetPaths.kitchen_fridge__png,1,0.25,60,true);
			stove = new PhysicsSprite(FlxG.save.data.living_room_stove.x,FlxG.save.data.living_room_stove.y,AssetPaths.kitchen_stove__png,1,0.25,60,true);
			drawers = new PhysicsSprite(FlxG.save.data.living_room_drawers.x,FlxG.save.data.living_room_drawers.y,AssetPaths.kitchen_drawers__png,1,0.25,60,true);
		}
		else
		{
			tv = new PhysicsSprite(
				OFFSET_X + 8*8,OFFSET_Y + 31*8,
				AssetPaths.living_room_tv__png,1,0.25,40,true,false,false,1,1,true,9,10);
			tv.animation.add("off",[1,1],1,false);
			tv.animation.add("on",[0,2,3,4],10,true);
		...
		dining_chair1 = new BedChair(
			dining_chair1_x,
			dining_chair1_y,
			AssetPaths.dining_room_chair_right__png,
			1,0.25,15,true,false,false,1,1,true,4,8,"",8,false,Physics.SOLID,Physics.SOLID|Physics.PARENT,this,FURNITURE);
		dining_chair1.setupAnimation(
			[0,0],[0,0],[1,1],[2,2],[3,3],
			PlayState.child1.childColor,PlayState.child1.childColor,PlayState.child2.childColor,PlayState.child3.childColor);
		...
		dining_chair2 = new BedChair(
			dining_chair2_x,
			dining_chair2_y,
			AssetPaths.dining_room_chair_right__png,
			1,0.25,15,true,false,false,1,1,true,4,8,"",8,false,Physics.SOLID,Physics.SOLID|Physics.PARENT,this,FURNITURE);
		dining_chair2.setupAnimation(
			[0,0],[0,0],[1,1],[2,2],[3,3],
			PlayState.child1.childColor,PlayState.child1.childColor,PlayState.child2.childColor,PlayState.child3.childColor);
		...
		dining_chair3 = new BedChair(
			dining_chair3_x,
			dining_chair3_y,
			AssetPaths.dining_room_chair_left__png,
			1,0.25,15,true,false,false,1,1,true,4,8,"",8,false,Physics.SOLID,Physics.SOLID|Physics.PARENT,this,FURNITURE);
		dining_chair3.setupAnimation(
			[0,0],[0,0],[1,1],[2,2],[3,3],
			PlayState.child1.childColor,PlayState.child1.childColor,PlayState.child2.childColor,PlayState.child3.childColor);
		...
		dining_chair4 = new BedChair(
			dining_chair4_x,
			dining_chair4_y,
			AssetPaths.dining_room_chair_left__png,
			1,0.25,15,true,false,false,1,1,true,4,8,"",8,false,Physics.SOLID,Physics.SOLID|Physics.PARENT,this,FURNITURE);
		dining_chair4.setupAnimation(
			[0,0],[0,0],[1,1],[2,2],[3,3],
			PlayState.child1.childColor,PlayState.child1.childColor,PlayState.child2.childColor,PlayState.child3.childColor);
		...
		var kitchen_bench_right:PhysicsSprite = new PhysicsSprite(OFFSET_X + 29*8,OFFSET_Y + 20*8,AssetPaths.kitchen_bench_right__png,1,0.25,5,false);




		if (FlxG.save.data.living_room_tv_on != null && FlxG.save.data.living_room_tv_on == true) tv.animation.play("on");
	...
	override public function destroy():Void
	{
		...
		for (i in 0...freeFoods.length) freeFoods[i].destroy();
	}
	...
	override public function update():Void
	{
		if (PlayState.parent.place != this &&
			...
			PlayState.child3.place != this) return;
	...
	public function fridgeEmitFood():Void
	{
		...
		if (foodEmitted > MAX_SINGLE_FOOD_SESSION) return;
	...
	override public function save():Void
	{
		...
		for (i in 0...foods.members.length)
		{
			...
			if (foods.members[i].alive) foodLocations.push(new FlxPoint(f.x,f.y));
		}
